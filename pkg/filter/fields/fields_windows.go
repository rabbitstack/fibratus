...
const (
	...
	// PsSignatureIsTrusted is the field which indicates if the binary signature is trusted
	PsSignatureIsTrusted Field = "ps.signature.is_trusted"
...
func (f Field) IsPeIsTrusted() bool { return f == PeIsTrusted || f == PsSignatureIsTrusted }
...
var fields = map[Field]FieldInfo{
	...
	PsSignatureIsTrusted:        {PsSignatureIsTrusted, "indicates if the process executable signature certificate chain is trusted", params.Bool, []string{"ps.signature.is_trusted"}, nil, nil},
	...
	PeIsTrusted:      {PeIsTrusted, "indicates if the PE certificate chain is trusted", params.Bool, []string{"pe.is_trusted"}, &Deprecation{Since: "3.0.0", Fields: []Field{PsSignatureIsTrusted}}, nil},
