...
var (
	...
	// CreateSymbolicLinkObject represents the event emitted by the object manager when the new symbolic link is created within the directory
...
func (k Ktype) Description() string {
	...
	case CreateSymbolicLinkObject:
		return "Creates the symbolic link object with the object manager directory"
	default:
		return ""
	}
}
