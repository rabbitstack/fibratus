    ...
    def parse_tcpip(self, ketype, ktcpip):
        ...
        if ketype in [SEND_SOCKET_TCPV4,
            ...
            if ketype in [SEND_SOCKET_TCPV4,
                ...
                l4_proto = 'UDP'
            application = port_to_proto(dport, l4_proto)
            if application == NA:
                application = port_to_proto(sport, l4_proto)
            ...
            self._kevent.params = dict(pid=pid, ip_src=ip_src, ip_dst=ip_dst,
                                       ...
                                       dport=dport,
                                       rwin=ktcpip.rcvwin,
                                       application=port_to_proto(sport, 'TCP'))
            ...
            self._kevent.params = dict(pid=pid,
                                       ...
                                       dport=dport,
                                       rwin=ktcpip.rcvwin,
                                       application=port_to_proto(dport, 'TCP'))
