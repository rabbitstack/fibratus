...
Fibratus is composed of a single binary which can be run from the terminal console. For better user experience a more sophisticated terminal emulators like ConEmu or Cmder are recommended.
