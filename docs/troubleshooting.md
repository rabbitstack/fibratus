...
These metrics are made available via Go’s expvar interface, which provides a lightweight, structured way to inspect counters, gauges, and other runtime values directly from within the application.

To quickly explore this telemetry, you can use the built-in CLI command:
